...
//        allow(role, ModuleName.PAYMENT, PermissionAction.CREATE);
    ...
    private void seedVendor() {
        Role role = getRole("VENDOR");

        allow(role, ModuleName.INVOICE, PermissionAction.VIEW);
        allow(role, ModuleName.INVOICE, PermissionAction.UPDATE);
        allow(role, ModuleName.INVOICE, PermissionAction.CREATE);
